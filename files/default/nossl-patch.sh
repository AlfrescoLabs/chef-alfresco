...
unzip /usr/share/tomcat/webapps/alfresco.war >> /var/log/messages
...
sleep 5
rm -rf /usr/share/tomcat/webapps/alfresco* >> /var/log/messages
mv -f alfresco.war /usr/share/tomcat/webapps/ >> /var/log/messages
