...
control 'alfresco-05' do
  ...
  describe directory('/usr/share/tomcat-multi/alf_data') do
    it { should exist }
  ...
  # describe directory('/usr/share/tomcat-multi/alf_data/keystore/alfresco/keystore') do
  #   it { should exist }
  #   it { should be_directory }
  # end
  # describe file('/usr/share/tomcat-multi/alf_data/keystore/alfresco/keystore/ssl.keystore') do
  #   it { should exist }
  #   it { should be_file }
  # end

  describe directory('/usr/share/tomcat-multi/shared/classes/alfresco/extension') do
    it { should exist }
    it { should be_directory }
    its('owner') { should cmp 'tomcat' }
    its('group') { should cmp 'tomcat' }
  ...
  describe file('/usr/share/tomcat-multi/shared/classes/alfresco/log4j.properties') do
    it { should exist }
    it { should be_file }
