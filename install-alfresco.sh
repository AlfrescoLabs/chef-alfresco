...
if [ -z "$COOKBOOKS_TARBALL_URL" ]; then
  ...
  COOKBOOKS_TARBALL_URL=https://artifacts.alfresco.com/nexus/service/local/repositories/snapshots/content/org/alfresco/devops/chef-alfresco/0.6.7-SNAPSHOT/chef-alfresco-0.6.7-20151022.144840-61.tar.gz
fi
