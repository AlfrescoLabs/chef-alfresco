...
default['solr6']['solr-in-sh']['SOLR_SSL_KEY_STORE'] = "#{node['solr6']['installation-path']}/#{node['artifacts']['alfresco-search-services']['artifactId']}/keystore/ssl.repo.client.keystore"
default['solr6']['solr-in-sh']['SOLR_SSL_KEY_STORE_PASSWORD'] = 'secret'
default['solr6']['solr-in-sh']['SOLR_SSL_TRUST_STORE'] = "#{node['solr6']['installation-path']}/#{node['artifacts']['alfresco-search-services']['artifactId']}/keystore/ssl.repo.client.truststore"
