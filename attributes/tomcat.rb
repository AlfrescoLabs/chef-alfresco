...
alfresco_memory = "#{(node['memory']['total'].to_i * 0.42 ).floor / 1024}m"
...
share_memory = "#{(node['memory']['total'].to_i * 0.28 ).floor / 1024}m"
...
solr_memory = "#{(node['memory']['total'].to_i * 0.3 ).floor / 1024}m"
