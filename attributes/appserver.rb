...
default['appserver']['alfresco']['solr']['home'] = lazy "#{node['alfresco']['properties']['dir.root']}/solrhome"
default['appserver']['alfresco']['solr']['alfresco_models'] = lazy { "#{node['alfresco']['properties']['dir.root']}/newAlfrescoModels" }
default['appserver']['alfresco']['solr']['contentstore.path'] = lazy { "#{node['alfresco']['properties']['dir.root']}/solrContentStore" }
