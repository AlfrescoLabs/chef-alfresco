...
node.default['amps']['repo']['aos-module']['groupId'] = 'org.alfresco.aos-module'
node.default['amps']['repo']['aos-module']['artifactId'] = 'alfresco-aos-module'
node.default['amps']['repo']['aos-module']['version'] = '1.1.5'
