...
default['activiti']['edition'] = "community"
default['activiti']['community']['properties']['jdbc.driver'] = 'com.mysql.jdbc.Driver'
...
default['activiti']['community']['properties']['jdbc.url'] = "jdbc:#{node['activiti']['properties']['db.prefix']}://#{node['activiti']['properties']['db.host']}:#{node['activiti']['properties']['db.port']}/#{node['activiti']['properties']['db.dbname']}?#{node['activiti']['properties']['db.params']}"
