...
#     block do
#       require 'fileutils'
#       FileUtils.cp "#{repo_properties_path}","#{tomcat_shared}/alfresco-global.properties"
#     end
#     subscribes  :create, "directory[root-dir]", :immediately
#   end  
# else
#   template "alfresco-global" do
#     path        "#{tomcat_shared}/alfresco-global.properties"
...
#     path        "#{tomcat_shared}/alfresco/extension/repo-log4j.properties"
