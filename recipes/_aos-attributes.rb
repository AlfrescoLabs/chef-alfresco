...
if node['tomcat']['run_base_instance']
  ...
  node.default['artifacts']['_vti_bin']['destination'] = "#{node['alfresco']['home']}-instances/alfresco/webapps"
  node.default['artifacts']['ROOT']['destination'] = "#{node['alfresco']['home']}-instances/alfresco/webapps"
end
