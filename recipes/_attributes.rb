...
node.default['alfresco']['properties']['opencmis.server.value'] = "{opencmis.server.protocol}://#{node['alfresco']['default_hostname']}#{node.default['alfresco']['properties']['alfresco.context']}/api"
