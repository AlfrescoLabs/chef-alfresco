...
cookbook 'alfresco-appserver', git: 'git@github.com:Alfresco/chef-alfresco-appserver.git', tag: 'v0.1'
# cookbook 'alfresco-appserver', path: '../chef-alfresco-splitting/chef-alfresco-appserver'
cookbook 'alfresco-utils', git: 'git@github.com:Alfresco/chef-alfresco-utils.git'
